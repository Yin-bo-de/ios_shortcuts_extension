# 项目进展 - LLM 快捷指令 iOS App

## 项目概览

**项目名称**: LLMCapability  
**目标**: 为 iOS 快捷指令提供第三方原子能力扩展，首期实现 LLM 调用能力  
...
### 2. 核心服务层 ✅
- [x] 实现 `HTTPClient`（基于 URLSession 的异步 HTTP 客户端）
